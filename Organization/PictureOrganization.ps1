...
"jpeg_pictures","adobe_illustrator","svg_pictures","adobe_photoshop","tiff_pictures","bitmap_pictures","gif_pictures","png_pictures","eps_pictures","raw_images" | %{mkdir $_}
...
Get-ChildItem "./*.jpg" | Move-Item -Destination "./tiff_pictures"
